...
int main(int argc, char ** argv)
{
	...
	//int elmtSize = 2; // it is the size for our morphological element, can be changed depending on how much our object to be affected
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			fgseg::bgs avsa_bgs(tau, weight_threshold, rgb, alpha); //construct object of the bgs class
