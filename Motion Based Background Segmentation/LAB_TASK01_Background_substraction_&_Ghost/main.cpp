...
int main(int argc, char ** argv)
{
	...
	/*string dataset_path =
			"/home/mohammad/eclipse-workspace/Lab.0AVS2020/AVSA_LAB1_dataset2012lite/dataset2012lite/dataset"; //SET THIS DIRECTORY according to your download
...
//
	string dataset_path =
			"/home/mohammad/eclipse-workspace/Lab.0AVS2020/AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_root_path = "//home/mohammad/eclipse-workspace/Lab.0AVS2020"; //SET THIS DIRECTORY according to your project
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			double tau = 45; // to set ... //Lab1.1.1-3
			double alpha = 0.03; // to set ... //Lab1.1.2-3
			bool selective_bkg_update = true; // true ... //Lab1.1.2-3
			int threshold_ghosts2 = 25; // to set ... //Lab1.1.3
			bool rgb = false; //true;

			//Shadow Detection Parameter
			double a = 0.3;		//alpha
			double beta = 0.5;		//Beta
			double s_tau = 60;	//saturation threshold
			double h_tau = 80;	//hue threshold
			...
			fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, rgb, a, beta,
					s_tau, h_tau);
